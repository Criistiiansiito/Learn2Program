...
async function seedDatabase() {
    try {
        ...
        await Recordatorios.create({
            fecha: new Date('2025-03-22T10:00:00Z'),
            email: 'usuario@example.com',
            mensaje: "No olvides completar el curso de C++ para obtener tu certificado.",
            asunto: "Recordatorio: Curso de C++",
            idUsuario: usuario.id  // Se asigna correctamente el idUsuario
        });
